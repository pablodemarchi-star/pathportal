...
class FinanceRequestsTest(unittest.TestCase):
    ...
    def test_link_folders_tab_renders_for_superadmin_only(self):
        ...
        self.assertIn('class="finance-link-folder-departments"', superadmin_body)
        self.assertIn('<span class="finance-link-folder-department">Finance</span>', superadmin_body)
        self.assertIn('<span class="finance-link-folder-department">Management</span>', superadmin_body)
